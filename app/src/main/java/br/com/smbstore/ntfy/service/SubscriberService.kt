...
import br.com.smbstore.ntfy.db.ConnectionState
 ...
 * - FCM receives keepalive message from the main br.com.smbstore.ntfy.sh server, which broadcasts an intent to AutoRestartReceiver,
...
class SubscriberService : Service() {
    ...
    private fun onNotificationReceived(subscription: Subscription, notification: br.com.smbstore.ntfy.db.Notification) {
    ...
    companion object {
        ...
        private const val NOTIFICATION_CHANNEL_ID = "br.com.smbstore.ntfy-subscriber"
        private const val NOTIFICATION_GROUP_ID = "io.heckel.br.com.smbstore.ntfy.NOTIFICATION_GROUP_SERVICE"
