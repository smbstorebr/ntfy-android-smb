...
import br.com.smbstore.ntfy.msg.ApiService.Companion.requestBuilder
import br.com.smbstore.ntfy.msg.NotificationParser
import br.com.smbstore.ntfy.util.Log
import br.com.smbstore.ntfy.util.topicShortUrl
import br.com.smbstore.ntfy.util.topicUrlWs
...
/**
 * Connect to br.com.smbstore.ntfy server via WebSockets. This connection represents a single connection to a server, with
