...
import br.com.smbstore.ntfy.msg.DownloadManager
import br.com.smbstore.ntfy.msg.DownloadType
...
class MainActivity : AppCompatActivity(), ActionMode.Callback, AddFragment.SubscribeListener, NotificationFragment.NotificationSettingsListener {
    ...
    override fun onSubscribe(topic: String, baseUrl: String, instant: Boolean, displayName: String?) {
        ...
        // Subscribe to Firebase topic if br.com.smbstore.ntfy.sh (even if instant, just to be sure!)
