...
import br.com.smbstore.ntfy.db.Action
...
class BroadcastService(private val ctx: Context) {
    ...
    companion object {
        ...
        private const val MESSAGE_RECEIVED_ACTION = "io.heckel.br.com.smbstore.ntfy.MESSAGE_RECEIVED"
        private const val MESSAGE_SEND_ACTION = "io.heckel.br.com.smbstore.ntfy.SEND_MESSAGE"
        private const val USER_ACTION_ACTION = "io.heckel.br.com.smbstore.ntfy.USER_ACTION"
    }
}
