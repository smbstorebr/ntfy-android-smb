package br.com.smbstore.ntfy.util

import android.content.Context
import android.os.Build
import br.com.smbstore.ntfy.BuildConfig
import br.com.smbstore.ntfy.backup.Backuper
import br.com.smbstore.ntfy.db.Database
import br.com.smbstore.ntfy.db.LogDao
import br.com.smbstore.ntfy.db.LogEntry
...
class Log(private val logsDao: LogDao) {
    ...
    private fun prependDeviceInfo(logs: String, settings: String, scrubLine: Boolean): String {
        val maybeScrubLine = if (scrubLine) "Server URLs (aside from br.com.smbstore.ntfy.sh) and topics have been replaced with fruits 🍌🥝🍋🥥🥑🍊🍎🍑.\n" else ""
        return """
            This is a log of the br.com.smbstore.ntfy Android app. The log shows up to 1,000 entries.
            $maybeScrubLine
            Device info:
            --
            br.com.smbstore.ntfy: ${BuildConfig.VERSION_NAME} (${BuildConfig.FLAVOR})
    ...
    companion object {
        ...
        private val IGNORE_TERMS = listOf("br.com.smbstore.ntfy.sh")
